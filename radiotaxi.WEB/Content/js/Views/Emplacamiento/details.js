        ...
        methods: {
            ...
            baja: function (eco) {
                ...
                swalWithBootstrapButtons.fire({
                    title: "¿Esta usted seguro que quiere dar de baja?",
                    ...
                    if (result.isConfirmed) {
                        // HACER EL PROCESO PERTINENTE PARA DAR DE BAJA AL VEHICULO.
                        var that = this;
                        $.ajaxSetup({
                            headers: { 'RequestVerificationToken': csrfToken }
                        });
                        $.ajax({
                            url: '/emplacamiento/baja/' + eco,
                            method: 'GET',
                            xhrFields: {
                                responseType: 'blob'
                            },
                            success: function (blob) {
                                ...
                                Swal.fire({
                                    ...
                                    icon: "success",
                                    title: "!Excelente!",
                                    text: "Vehículo dado de baja, correctamente.",
                                ...
                                a.download = '8624-BAJA-' + fechaFormateada + '.pdf'; // nombre opcional
                            ...
                            error: function (xhr, status, error) {
                                ...
                                Swal.fire({
                                    ...
                                    text: "Verifique los datos correctos!"
                                });
                            }
                        });
                    } else if (
                        ...
                        swalWithBootstrapButtons.fire({
                            title: "Cancelado",
                            text: "Usted CANCELO la baja del vehículo",
                            icon: "error"
                        });
                    }
                });
