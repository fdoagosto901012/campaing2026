...
{
    public class TaxiServicesPagination
    {
        public TaxiServicesPagination(int totalItems, List<TaxiServicesDTO> data, int page, int pageSize = 10)
        {
        ...
        public List<TaxiServicesDTO> Data { get; set; }
    }
}
